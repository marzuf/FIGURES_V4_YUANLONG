...
# Rscript barplot_with_FCC_fract_permut.R
...
outFolder <- "BARPLOT_WITH_FCC_FRACT_PERMUT"
...
auc_ratio_file <- file.path("BARPLOT_FCC_AUC_RATIO_PERMUT", "all_dt.Rdata")
...
signif_file <- file.path(runFolder, "CREATE_FINAL_TABLE_PERMUT/all_result_dt.Rdata")
